...
6.	Ras Signaling (Important for Growth factors, cancer usually have activated Ras):
    ...
    * (https://blog.crownbio.com/targeting-ras-oncology)
...
9.	TGF Beta
    ...
    * (https://www.frontiersin.org/articles/10.3389/fonc.2018.00357/full)
10. Insulin
    ...
    * (https://www.researchgate.net/figure/Insulin-signaling-pathway-The-tyrosine-phosphorylated-IRS-1-activates-phosphoinosiditde_fig2_322308358)
...
12. Import Process:
    ...
    *	  (https://www.mechanobio.info/what-is-mechanosignaling/what-are-small-gtpases/what-are-ran-gtpases/)
13.	Export process:
