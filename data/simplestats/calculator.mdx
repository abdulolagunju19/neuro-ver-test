...
int stands for integer. s is the arbitrary name of a function (don’t give bad function names, it makes your code impossible to read later). x is the arbitrary name for the variable going in the function, often used in algebra. We call this the parameter of the function. 
