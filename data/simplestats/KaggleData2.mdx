...
This is a continuation of my blog post on using python to analyze data. The link to that blog post is here: [Kaggle Data Analysis Blog Post](https://neuro-ver-test-19qnqtrjm-abdulolagunju19.vercel.app/simplestats/KaggleData)
